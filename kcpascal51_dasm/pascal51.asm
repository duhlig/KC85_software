; z80dasm 1.1.6
; command line: z80dasm -a -b p51.block -g 0x200 -l -S p51.sym -s p51.symout -t -u -o pascal51.asm pascal51_kcc.bin
...
Save:
	...
	ld (iobuf+17),hl		;02fc	22 91 00 	" . . 
	ld hl,iobuf+11		;02ff	21 8b 00 	! . . 
...
KillMem:
	...
	ld (iobuf+19),de		;030e	ed 53 93 00 	. S . . 
	ld a,002h		;0312	3e 02 	> . 
l0314h:
	ld (iobuf+16),a		;0314	32 90 00 	2 . . 
	ld a,(fileExt)		;0317	3a 00 07 	: . . 
	cp 043h		;031a	fe 43 	. C 
	jr nz,C_ISRO		;031c	20 2e 	  . 
	ld a,d			;031e	7a 	z 
	ld (iobuf+19),a		;031f	32 93 00 	2 . . 
	ld hl,l04d5h		;0322	21 d5 04 	! . . 
	ld (iobuf+20),hl		;0325	22 94 00 	" . . 
...
FName2Menu:
	ld a,(hl)			;033f	7e 	~ 
	cp 020h		;0340	fe 20 	.   
	jr z,C_ISRO		;0342	28 08 	( . 
	or a			;0344	b7 	. 
	jr z,C_ISRO		;0345	28 05 	( . 
	ld (de),a			;0347	12 	. 
	inc hl			;0348	23 	# 
	inc de			;0349	13 	. 
...
CmpFNamNxtChr:
	...
	ld de,(iobuf+17)		;0445	ed 5b 91 00 	. [ . . 
	ld hl,(iobuf+19)		;0449	2a 93 00 	* . . 
	or a			;044c	b7 	. 
...
LxIdAllChrsRead:
	...
	ld hl,RL_PROCEDURE		;3156	21 62 32 	! b 2 
	push de			;3159	d5 	. 
...
RL_PACKED:
	...
	defb 023h		;3179	23 	# 
RL_NIL:
	defw RL_PACKED		;317a	71 31 	q 1 
	defb 04eh		;317c	4e 	N 
	defb 049h		;317d	49 	I 
	defb 0cch		;317e	cc 	. 
	defb 022h		;317f	22 	" 
RL_FORWARD:
	defw RL_NIL		;3180	7a 31 	z 1 
	defb 046h		;3182	46 	F 
	defb 04fh		;3183	4f 	O 
	defb 052h		;3184	52 	R 
	defb 057h		;3185	57 	W 
...
RL_PROGRAM:
	...
	defb 001h		;3193	01 	. 
RL_IN:
	defw RL_PROGRAM		;3194	8a 31 	. 1 
	defb 049h		;3196	49 	I 
	defb 0ceh		;3197	ce 	. 
	defb 020h		;3198	20 	  
RL_OR:
	defw RL_IN		;3199	94 31 	. 1 
	defb 04fh		;319b	4f 	O 
	defb 0d2h		;319c	d2 	. 
	defb 007h		;319d	07 	. 
RL_ON:
	defw RL_OR		;319e	99 31 	. 1 
	defb 04fh		;31a0	4f 	O 
	defb 0c6h		;31a1	c6 	. 
	defb 00bh		;31a2	0b 	. 
RL_TO:
	defw RL_ON		;31a3	9e 31 	. 1 
	defb 054h		;31a5	54 	T 
	defb 0cfh		;31a6	cf 	. 
	defb 00ch		;31a7	0c 	. 
RL_DO:
	defw RL_TO		;31a8	a3 31 	. 1 
	defb 044h		;31aa	44 	D 
	defb 0cfh		;31ab	cf 	. 
	defb 011h		;31ac	11 	. 
RL_IF:
	defw RL_DO		;31ad	a8 31 	. 1 
	defb 049h		;31af	49 	I 
	defb 0c6h		;31b0	c6 	. 
	defb 017h		;31b1	17 	. 
RL_SET:
	defw RL_IF		;31b2	ad 31 	. 1 
	defb 053h		;31b4	53 	S 
	defb 045h		;31b5	45 	E 
	defb 0d4h		;31b6	d4 	. 
	defb 01bh		;31b7	1b 	. 
RL_NOT:
	defw RL_SET		;31b8	b2 31 	. 1 
	defb 04eh		;31ba	4e 	N 
	defb 04fh		;31bb	4f 	O 
	defb 0d4h		;31bc	d4 	. 
	defb 006h		;31bd	06 	. 
RL_MOD:
	defw RL_NOT		;31be	b8 31 	. 1 
	defb 04dh		;31c0	4d 	M 
	defb 04fh		;31c1	4f 	O 
	defb 0c4h		;31c2	c4 	. 
	defb 009h		;31c3	09 	. 
RL_DIV:
	defw RL_MOD		;31c4	be 31 	. 1 
	defb 044h		;31c6	44 	D 
	defb 049h		;31c7	49 	I 
	defb 0d6h		;31c8	d6 	. 
	defb 002h		;31c9	02 	. 
RL_VAR:
	defw RL_DIV		;31ca	c4 31 	. 1 
	defb 056h		;31cc	56 	V 
	defb 041h		;31cd	41 	A 
	defb 0d2h		;31ce	d2 	. 
	defb 00ah		;31cf	0a 	. 
RL_AND:
	defw RL_VAR		;31d0	ca 31 	. 1 
	defb 041h		;31d2	41 	A 
	defb 04eh		;31d3	4e 	N 
	defb 0c4h		;31d4	c4 	. 
	defb 008h		;31d5	08 	. 
RL_FOR:
	defw RL_AND		;31d6	d0 31 	. 1 
	defb 046h		;31d8	46 	F 
	defb 04fh		;31d9	4f 	O 
	defb 0d2h		;31da	d2 	. 
	defb 016h		;31db	16 	. 
RL_END:
	defw RL_FOR		;31dc	d6 31 	. 1 
	defb 045h		;31de	45 	E 
	defb 04eh		;31df	4e 	N 
	defb 0c4h		;31e0	c4 	. 
	defb 010h		;31e1	10 	. 
RL_GOTO:
	defw RL_END		;31e2	dc 31 	. 1 
	defb 047h		;31e4	47 	G 
	defb 04fh		;31e5	4f 	O 
	defb 054h		;31e6	54 	T 
	defb 0cfh		;31e7	cf 	. 
...
RL_PROCEDURE:
ResWordsEntry2:
	defw RL_FUNCTION		;3262	57 32 	W 2 
	defb 050h		;3264	50 	P 
	defb 052h		;3265	52 	R 
	defb 04fh		;3266	4f 	O 
	defb 043h		;3267	43 	C 
	...
	defb 004h		;326d	04 	. 
ResWordsEntry:
	defw RL_PROCEDURE		;326e	62 32 	b 2 
TEadr:
